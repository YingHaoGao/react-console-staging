    ...
    return (
     <div className="tableBox">
        <table>
          ...
          <tbody>
            <tr>
              <td className="borR" rowSpan="3">{__('maintenance-manpower-cost')}</td>
              <td className="borD">
          ...
          <tbody>
            <tr>
              <td className="borR" rowSpan="4">{__('maintenance-personnel-budget')}</td>
              <td className="borD">
        ...
        <h2>{__('maintenance-total-cost')}:&ensp;{info.name}</h2>
      </div>
    )
  }
}
